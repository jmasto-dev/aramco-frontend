...
// in aramco_frontend/test/employee_test.dart.
...
import 'package:aramco_frontend/core/services/employee_service.dart' as _i3;
...
class MockEmployeeService extends _i1.Mock implements _i3.EmployeeService {
  ...
  @override
  _i4.Future<_i2.ApiResponse<dynamic>> getEmployees({
    int? page = 1,
    int? limit = 20,
    dynamic filters,
    String? search,
